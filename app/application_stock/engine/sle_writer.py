...
def append_sle(
    ...
    *,
    ...
    # Prevent negative stock quantities on issues
    ...
    out_rate_final: Optional[Decimal] = out_rate
    ...
    if intent.actual_qty > 0 and in_rate is not None:
        ...
        logger.info("append_sle: After receipt - qty_after: %s, rate_after: %s, value_diff: %s", qty_after, rate_after, value_diff)
        ...
        logger.info("append_sle: After issue - qty_after: %s, rate_after: %s, value_diff: %s", qty_after, rate_after, value_diff)
    else:
        ...
        qty_after, rate_after, value_diff = ma.apply_zero_qty_revaluation(prev_qty, prev_rate, intent.stock_value_difference)
        logger.info("append_sle: After revaluation - qty_after: %s, rate_after: %s, value_diff: %s", qty_after, rate_after, value_diff)
