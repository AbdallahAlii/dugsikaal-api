...
from app.application_accounting.query_builders.mop_dropdowns import (
    build_modes_of_payment_dropdown,
    build_mop_accounts_dropdown,
    build_vat_account_dropdown,
    build_asset_accounts_dropdown,
    build_expense_type_accounts_dropdown,
    build_expense_accounts_dropdown,
    build_expense_type_default_account_dropdown,
    build_expense_types_dropdown,
    build_parties_dropdown,
    build_accounts_dropdown,
    build_fiscal_years_dropdown,
    build_pcv_closing_accounts_dropdown,
)

ACCOUNTING_DROPDOWN_CONFIGS = {
    # Modes of Payment (company-wide)
    "modes_of_payment": DropdownConfig(
        permission_tag="ModeOfPayment",
        query_builder=build_modes_of_payment_dropdown,
        search_fields=[ModeOfPayment.name],
    ...
    "mop_accounts": DropdownConfig(
        ...
        filter_fields={
            "mode_of_payment_id": ModeOfPaymentAccount.mode_of_payment_id,
            "mop_id": ModeOfPaymentAccount.mode_of_payment_id,  # alias key
    ...
    # Default account for Expense Type
    "expense_type_default_account": DropdownConfig(
        permission_tag="Account",
        query_builder=build_expense_type_default_account_dropdown,
        search_fields=[Account.name, Account.code],
    ...
    # Expense Type -> Accounts (default pinned first)
    "expense_type_accounts": DropdownConfig(
        permission_tag="Account",
        query_builder=build_expense_type_accounts_dropdown,
        search_fields=[Account.name, Account.code],
    ...
    # Parties (Customers/Suppliers/Employees) by type – company-wide
    "parties_by_type": DropdownConfig(
        permission_tag="Party",
        query_builder=build_parties_dropdown,
        search_fields=[],  # search handled inside builder (tokens)
        filter_fields={
            "party_type": None,
            "party_kind": None,
            "role": None,
    ...
    # Fiscal Years dropdown (for PCV and other flows)
    "fiscal_years": DropdownConfig(
        permission_tag="FiscalYear",
        query_builder=build_fiscal_years_dropdown,
    ...
    # PCV Closing Account Head dropdown
    "pcv_closing_accounts": DropdownConfig(
        permission_tag="Account",
        query_builder=build_pcv_closing_accounts_dropdown,
        search_fields=[Account.name, Account.code],
        filter_fields={
            "account_type": Account.account_type,
            "parent_account_id": Account.parent_account_id,
