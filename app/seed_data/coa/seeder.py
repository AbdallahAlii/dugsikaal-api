...
#     DebitOrCreditEnum,
# )
# from app.application_stock.stock_models import DocStatusEnum  # Draft/Submitted/Cancelled/Archived
...
#     set_status_submitted: bool = True,
...
#         status=DocStatusEnum.SUBMITTED if set_status_submitted else DocStatusEnum.DRAFT,
#     )
...
#             # Optionally promote status to SUBMITTED on seed
#             if set_status_submitted and acc.status != DocStatusEnum.SUBMITTED:
#                 acc.status = DocStatusEnum.SUBMITTED; changed = True
#             if changed:
#                 updated += 1
#
#         # Cache for children
