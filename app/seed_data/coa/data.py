...
DEFAULT_ACCOUNTS: List[Dict[str, Any]] = [
    ...
    {"code": "1112", "name": "Merchant Cashier", "is_group": False, "parent_code": "1110", "account_type": "ASSET"},
    {"code": "1113", "name": "E-dahab", "is_group": False, "parent_code": "1110", "account_type": "ASSET"},
    {"code": "1114", "name": "Somnet", "is_group": False, "parent_code": "1110", "account_type": "ASSET"},

    {"code": "1120", "name": "Bank Accounts", "is_group": True, "parent_code": "1100", "account_type": "ASSET"},
    {"code": "1121", "name": "Sallam Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    {"code": "1122", "name": "Dahabshiil Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    {"code": "1123", "name": "Amal Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    {"code": "1124", "name": "IBS Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    {"code": "1125", "name": "Som Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    {"code": "1126", "name": "Idman Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    {"code": "1127", "name": "Premier Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    {"code": "1128", "name": "My Bank", "is_group": False, "parent_code": "1120", "account_type": "ASSET"},
    ...
    {"code": "1132", "name": "Insurance Receivable", "is_group": False, "parent_code": "1130", "account_type": "ASSET"},
    ...
    {"code": "3002", "name": "Owner's Drawings", "is_group": False, "parent_code": "3000", "account_type": "EQUITY"},
    ...
    {"code": "4103", "name": "Maintenance Income", "is_group": False, "parent_code": "4100", "account_type": "INCOME"},
    ...
    {"code": "5012", "name": "Landed Cost Variance", "is_group": False, "parent_code": "5010", "account_type": "EXPENSE"},
    ...
    {"code": "5101", "name": "Commission on Sales", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5102", "name": "Travel Expenses", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5103", "name": "Meals & Drinks Expenses", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5104", "name": "Entertainment Expenses", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5105", "name": "Training Expenses", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5106", "name": "Salaries Expense", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5107", "name": "Repairs & Maintenance", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},

    {"code": "5108", "name": "Utilities", "is_group": True, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "51081", "name": "Electricity Expense", "is_group": False, "parent_code": "5108", "account_type": "EXPENSE"},
    {"code": "51082", "name": "Water Expense", "is_group": False, "parent_code": "5108", "account_type": "EXPENSE"},
    {"code": "51083", "name": "Internet & Telecom Expense", "is_group": False, "parent_code": "5108", "account_type": "EXPENSE"},

    {"code": "5109", "name": "Rent Expense", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5110", "name": "Taxes & Licenses Expense", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5111", "name": "Marketing & Advertising", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5112", "name": "Office Maintenance", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5113", "name": "Round Off Expense", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5114", "name": "Miscellaneous Expenses", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5115", "name": "Public Transport Expenses", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5116", "name": "Discounts Allowed", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5117", "name": "Donations & Charity (Sadaqa)", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5118", "name": "Bad Debt Expense", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5119", "name": "Depreciation Expense", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
    {"code": "5120", "name": "Bank Charges & Fees", "is_group": False, "parent_code": "5100", "account_type": "EXPENSE"},
]