...
WORKSPACES: list[dict] = [
    ...
    # === SELLING ===
    {
        ...
        "root_links": [
            {
                "label": "Customer",
                "path": "/selling/customer/list",
                "icon": "user",
                "perm": "Customer:READ",
            },
            {
                "label": "Quotation",
                "path": "/selling/sales-quotation/list",
                "icon": "file-badge",
                "perm": "Sales Quotation:READ",
            },
            {
                "label": "Sales Invoice",
                "path": "/selling/sales-invoice/list",
                "icon": "receipt",
                ...
                "links": [
                    {
                        ...
                        "path": "/accounts/report/accounts-receivable",
                        "icon": "user-plus",
                    ...
                    {
                        "label": "Sales Item Report",
                        "path": "/accounts/report/gross-profit",
                        "icon": "percent",
    ...
    # === BUYING ===
    {
        ...
        "root_links": [
            {
                "label": "Supplier",
                "path": "/buying/supplier/list",
                "icon": "user-round",
                "perm": "Supplier:READ",
            },
            {
                "label": "Quotation",
                "path": "/buying/purchase-quotation/list",
                "icon": "quote",
                "perm": "Purchase Quotation:READ",
            },
            {
                "label": "Purchase Receipt",
                "path": "/buying/purchase-receipt/list",
                "icon": "package",
                "perm": "Purchase Receipt:READ",
            },
            {
                "label": "Purchase Invoice",
                "path": "/buying/purchase-invoice/list",
                "icon": "receipt",
                ...
                "links": [
                    {
                        ...
                        "path": "/accounts/report/accounts-payable",
                        "icon": "user-minus",
    ...
    # === STOCK ===
    {
        ...
        "root_links": [
            ...
            {
                "label": "Stock Entry",
                "path": "/stock/stock-entry/list",
                "icon": "arrows-left-right",
                "perm": "Stock Entry:READ",
            },
            {
                "label": "Stock Reconciliation",
                "path": "/stock/stock-reconciliation/list",
                "icon": "scale",
        ...
        "sections": [
            {
                ...
                "links": [
                    {
                        "label": "Total Stock Summary",
                        "path": "/stock/report/total-stock-summary",
                        "icon": "archive",
                        "perm": "Total Stock Summary Report:READ",
                    },
                    {
                        "label": "Stock Balance",
                        "path": "/stock/report/stock-balance",
                        "icon": "scale",
                        "perm": "Stock Balance Report:READ",  # <-- added
                    },
                    {
                        "label": "Stock Ledger",
    ...
    # === HR ===
    {
        ...
        "root_links": [
            ...
            },
            {
                ...
                "path": "/hr/employee-checkin/list",
                "icon": "log-in",
                "perm": "Employee Checkin:READ",
            },
            {
                "label": "Shift Type",
                "path": "/hr/shift-type/list",
                "icon": "clock",
                "perm": "Shift Type:READ",
            },
            {
                "label": "Employee Group",
                "path": "/hr/employee-group/list",
                "icon": "users",
                "perm": "Employee Group:READ",
            },
            {
                "label": "Employee Health Insurance",
                "path": "/hr/employee-health-insurance/list",
                "icon": "heart-pulse",
    ...
    # === HOST ADMINISTRATION (SYSTEM ADMIN ONLY) ===
    {
        ...
        "root_links": [
            # Client Management
            {"label": "Clients", "path": "/host-admin/tenant/list", "icon": "building-2", "perm": "Tenant:READ"},
        ...
        "sections": [
            {
                ...
                "links": [
                    ...
                    {
                        "label": "Data Import Log",
                        "path": "/host-admin/data-import-log/list",
                        "icon": "list-ordered",
                        "perm": "Data Import Log:READ",
                    },
                ],
            },
        ],
        ...
        "sections": [
            {
                ...
                "links": [
                    ...
                    },
                    {
                        ...
                        "path": "/system/role-permission/list",
                        "icon": "shield-check",
                        "perm": "Role Permission:READ",
                    },
                    {
                        "label": "User Role",
                        "path": "/system/user-role/list",
                        "icon": "shield",
                        "perm": "User Role:READ",
                    },
                    {
                        "label": "Permission Override",
                        "path": "/system/permission-override/list",
                        "icon": "lock-keyhole",
                        "perm": "Permission Override:READ",
                    },
                    {
                        "label": "User Constraint",
                        "path": "/system/user-constraint/list",
                        "icon": "scan-line",
