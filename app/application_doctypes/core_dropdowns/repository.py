...
#
#         def _builder():
#             sel: Select = cfg.query_builder(session=db.session, context=user_context, params=params_for_cache["filters"])
...
#
#             # Optional sort/order only if declared
#             if cfg.sort_fields:
